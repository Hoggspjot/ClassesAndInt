package year25.december.day051225.task1;
...
public class Main {
    ...
    public static List<String> findPNGFiles(List<String> files) {
        return files.stream().filter(x -> x.contains(".png")).collect(Collectors.toList());
    }
 ...
 *
 * Напишите код, который находит все файлы в массиве files с расширением .png и записывает новый массив в переменную result.*/